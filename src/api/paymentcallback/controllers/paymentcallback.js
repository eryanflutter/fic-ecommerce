...
module.exports = createCoreController('api::paymentcallback.paymentcallback', ({ strapi }) => ({
    async create(ctx) {
        ...
        const result = await strapi.service('api::paymentcallback.paymentcallback').create(inputData);
